...
func (_m *User) UpdateUser(ctx context.Context, req *user.UpdateUserRequest) (*models.User, error) {
	ret := _m.Called(ctx, req)

	var r0 *models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *user.UpdateUserRequest) (*models.User, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *user.UpdateUserRequest) *models.User); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.User)
...
// User_UpdateUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateUser'
type User_UpdateUser_Call struct {
	*mock.Call
}
...
func (_e *User_Expecter) UpdateUser(ctx interface{}, req interface{}) *User_UpdateUser_Call {
	return &User_UpdateUser_Call{Call: _e.mock.On("UpdateUser", ctx, req)}
}

func (_c *User_UpdateUser_Call) Run(run func(ctx context.Context, req *user.UpdateUserRequest)) *User_UpdateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *User_UpdateUser_Call) Return(_a0 *models.User, _a1 error) *User_UpdateUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *User_UpdateUser_Call) RunAndReturn(run func(context.Context, *user.UpdateUserRequest) (*models.User, error)) *User_UpdateUser_Call {
	_c.Call.Return(run)
	return _c
}
