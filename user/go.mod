module github.com/goravel-ecosystem/market-backend/users

go 1.21.0

require (
	github.com/goravel-ecosystem/market-backend/proto v0.0.0
	github.com/goravel/framework v1.13.1-0.20231202110538-251c078ac266
	github.com/goravel/gin v1.1.6-0.20231129014028-a3a3b531dd4f
...
replace (
	github.com/goravel-ecosystem/market-backend/gateway => ../gateway
