...
require (
	github.com/goravel-ecosystem/market-backend/gateway v0.0.0-f250ab1585612083138a153a75c1602913206330
...
replace github.com/goravel-ecosystem/market-backend/gateway => ../gateway
